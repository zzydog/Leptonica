...
#if defined(WINAPI_FAMILY) || defined(_MSC_VER) || defined(_WIN32)
#  define open _open
#  define read _read
#  define write _write
#  define close _close
 ...
 * (this and twice this must be able to fit in an unsigned type) 
 */
#define GZBUFSIZE 8192

/* 
 * gzip modes, also provide a little integrity check on the passed 
 * structure 
 */
#define GZ_NONE 0
#define GZ_READ 7247
